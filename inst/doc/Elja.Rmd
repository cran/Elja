...
In order to show in a simple way the use of the Elja package, we will use a synthetic diabetes dataset mimicking the original PIMA data. 
This dataset is present in the package mlbench (https://CRAN.R-project.org/package=mlbench).
